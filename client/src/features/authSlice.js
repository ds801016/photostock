...
const isLogged = () => {
  const u = JSON.parse(localStorage.getItem("photoStockUser"));
  if (u == undefined) {
    localStorage.clear();
    return null;
  } else return u;
};
console.log(JSON.parse(localStorage.getItem("photoStockUser")));
const initialState = {
  user: JSON.parse(localStorage.getItem("photoStockUser")),
  isSuccess: false,
  isError: false,
  isLoading: false,
  message: "",
...
export const register = createAsyncThunk(
  ...
  async (newUser, thunkAPI) => {
    try {
      ...
      localStorage.setItem("photoStockUser", JSON.stringify(data.user));
